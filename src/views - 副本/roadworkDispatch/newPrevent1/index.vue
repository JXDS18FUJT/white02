...
<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="分派状态">
      ...
      <el-table-column align="center" label="办事状态">
      ...
      <el-table-column label="操作" align="center" width="300" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          ...
          <el-button type="success" size="mini" @click="handleUpdate(row)">分派施工管理员</el-button>
        </template>
      </el-table-column>
    </el-table>
