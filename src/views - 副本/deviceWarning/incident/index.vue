...
<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="报警日期">
      ...
      <el-table-column align="center" label="类型">
        ...
        <template slot-scope="scope">{{ scope.row.warnGeade }}级预警</template>
      </el-table-column>
      <el-table-column align="center" label="工程名称">
        <template slot-scope="scope">{{ scope.row.project }}</template>
      </el-table-column>
            <!-- <el-table-column align="center" label="药品单位">
        <template slot-scope="scope">kg</template>
      </el-table-column> -->
      <el-table-column align="center" label="监测总数">
        <template slot-scope="scope">{{scope.row.signal}}</template>
      </el-table-column>
                    <el-table-column align="center" label="异常总数">
        <template slot-scope="scope">{{ scope.row.errorNumber}}</template>
      </el-table-column>
      ...
      <!-- <el-table-column label="操作" align="center" width="300" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          ...
          <el-button type="success" size="mini" @click="handleUpdate(row)">修改</el-button> 
              <el-button type="success" size="mini" @click="handleUpdate(row)">下架</el-button>
        </template>
      </el-table-column> -->
    </el-table>
