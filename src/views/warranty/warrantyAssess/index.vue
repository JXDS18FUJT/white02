...
<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="评估项ID">
      ...
      <el-table-column align="center" label="办事类型">
      ...
      <el-table-column align="center" label="施工类型">
        <template slot-scope="scope">{{ scope.row.type }}</template>
      </el-table-column>
            <el-table-column align="center" label="评估项名称">
        <template slot-scope="scope">{{scope.row.assessment}}</template>
      </el-table-column>
      ...
      <!-- <el-table-column align="center" label="工程名称">
        ...
        <template slot-scope="scope">{{ scope.row.state2}}</template>
      </el-table-column>
      <el-table-column label="操作" align="center" width="300" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          ...
          <el-button type="success" size="mini" @click="handleUpdate(row)">修改</el-button>
              <!-- <el-button type="success" size="mini" @click="handleUpdate(row)">验收</el-button> -->
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { getWarrantyData } from "@/api/warranty/index.js";
export default {
  data() {
    return {
      options: [
