  ...
  <div class="app-container">
    ...
    >
      <el-table-column align="center" label="序号" width="80">
        <template slot-scope="scope">
          <span>{{ scope.$index+1 }}</span>
            ...
            <el-table-column align="center" label="资讯ID">
      ...
      <el-table-column align="center" label="上下架">
        <template slot-scope="scope">{{ scope.row.beforeAfterShelf }}</template>
      </el-table-column>
    ...
    <el-button type="danger" size="mini" @click="handleUpdate(row)">删除</el-button>
                       <el-button type="success" size="mini" @click="handleUpdate(row)">上架</el-button>
